...
function MyTabBar({state, descriptors, navigation, position}) {
  return (
    <View>
      <View>
        <Text style={{marginBottom: 10}}>top</Text>
      </View>
          ...
          return (
            <>
              <TouchableOpacity
                ...
                <Animated.Text style={{opacity, backgroundColor: 'rgba(255, 255, 255, .5)', height: 40, top: -17, elevate: 3}}></Animated.Text>
                <Animated.Text style={{opacity, backgroundColor: 'red', height: 5}}></Animated.Text>
              </TouchableOpacity>
            </>
          );
        })}
